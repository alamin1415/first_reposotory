...
public class melborn  extends JFrame{
	...
	melborn(){
		...
		i1=new ImageIcon(getClass().getResource("/images/melborn.png"));
		Im1=i1.getImage();
		...
		i2=new ImageIcon(getClass().getResource("/images/abui.jpg"));
		Im3=i2.getImage();
		...
		i5=new ImageIcon(getClass().getResource("/images/syii.jpg"));
		Im11=i5.getImage();
